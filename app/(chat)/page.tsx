    ...
    return (
      <>
        <div style={{ padding: '20px', lineHeight: '1.6' }}>
          <h1 style={{ fontSize: '2em', fontWeight: 'bold' }}>Seoan AI에 오신 것을 환영합니다! 당신의 똑똑한 AI 조수</h1>
          ...
          <h2 style={{ fontSize: '1.5em', fontWeight: 'bold', marginTop: '30px' }}>Seoan AI가 도와드릴 수 있는 것들!</h2>
          ...
          <h2 style={{ fontSize: '1.5em', fontWeight: 'bold', marginTop: '30px' }}>Seoan AI, 더욱 강력해진 능력!</h2>
          ...
          <p>Seoan AI는 언제나 사용자 여러분의 곁에서 최고의 AI 경험을 제공하기 위해 노력할 것입니다. 지금 바로 더욱 강력해진 Seoan AI를 경험해보세요! 당신의 가능성을 활짝 열어줄 것입니다!</p>
        </div>
        <Chat
          key={id}
          id={id}
